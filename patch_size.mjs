    ...
    <section ref={sectionRef} className="w-full bg-[#0a0a0a] text-white px-4 md:px-12 py-24 md:py-32 flex flex-col font-sans uppercase z-10 relative selection:bg-white selection:text-black">
      ...
      <div className="w-full mb-20 md:mb-28 mt-12 md:mt-24">
        ...
        <div className="w-full md:pl-[30%] mt-12 md:mt-16 text-left shrink-0">
          <p className="about-reveal text-xs md:text-sm lg:text-base font-bold uppercase leading-[1.6] opacity-90 text-white max-w-4xl tracking-wide text-justify">
      ...
      <div className="w-full flex mb-24 md:mb-32 flex-col gap-10 md:gap-16">
        <div className="w-full flex flex-col md:flex-row">
          <div className="w-full md:w-[30%] shrink-0 mb-4 md:mb-0">
            <div className="about-reveal text-[10px] md:text-sm lg:text-base font-bold tracking-widest leading-[2] uppercase">
              ПОДХОД
            </div>
          </div>
          <div className="w-full md:w-[70%]">
            <p className="about-reveal text-xs md:text-sm lg:text-base font-medium leading-[1.8] opacity-80 text-justify max-w-4xl normal-case">
      ...
      <div className="flex flex-col md:flex-row items-start w-full">
        ...
        <div className="w-full md:w-[70%] flex flex-col gap-10 md:gap-14 max-w-[90%] md:max-w-none pr-0 xl:pr-[15%]">
           ...
           <div className="flex flex-col md:flex-row gap-6 md:gap-8 text-[11px] md:text-sm font-medium leading-[1.8] opacity-80 text-justify pr-0 xl:pr-[5%] normal-case mt-4">
...
console.log('Successfully patched AboutSection with larger text');
